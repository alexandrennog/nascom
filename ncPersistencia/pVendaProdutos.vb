    ...
    Public Class pVendaProduto
        ...
        Public Function ConsultarTroca(ByVal dados As dVendaProduto) As ColecaoVendaProduto
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em Consultar troca [" & Me.ToString() & "] - " & ex.Message, ex)
        ...
        Public Function IncluirTroca(ByVal dados As dVendaProduto) As Integer
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em Incluir Troca [" & Me.ToString() & "] - " & ex.Message, ex)
