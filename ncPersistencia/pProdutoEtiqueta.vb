  ...
  Public Class pProdutoEtiqueta
    ...
    Public Function Listar(ByVal dataDe As String, ByVal dataAte As String) As ColecaoProdutoEtiqueta
      ...
      Try
        ...
        sqlSelect = " Select data, impressao, produto_cid, produtoItem_codigoBarras, quantidade, " & _
            " usuario_cid, usuario_nomeCompleto, referencia, c.nome as cor"
        sqlWhere = String.Empty
        sqlFrom = " From LogEstoque le " & _
        " inner join produtos p on p.cid = le.produto_cid " & _
        " inner join cor c on p.cor_cid = c.cid " & _
    ...
    Public Function Alterar(ByVal data As String, ByVal produto As String, ByVal codigoBarras As String) As Integer
      ...
      Try
        ...
        comandoSQL = " UPDATE logEstoque SET " & _
            " impressao = 'S' " & _
            " WHERE " & _
            " data = " & PersistirData(data) & " AND " & _
            " produto_cid = " & PersistirInteiro(produto) & " AND " & _
