  ...
  Public Class pCheques
    ...
    Public Function Alterar(ByVal dados As dCheques) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Alterar Cheque [" & Me.ToString() & "] - " & ex.Message, ex)
    ...
    Public Function Excluir(ByVal dados As dCheques) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Excluir Cheque [" & Me.ToString() & "] - " & ex.Message, ex)
