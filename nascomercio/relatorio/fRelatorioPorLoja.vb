...
Public Class fRelatorioPorLoja
    ...
    Private Sub Filtrar()
        ...
        Dim otherItems As String() = {"TotalVendas", "QuantidadeProdutos", "ValorTotalVendas", "TicketMedio", "PercentualAtingimento"}
        Me.lstPix.View = View.Details
    ...
    Private Sub ConfigurarRelatorio(ByVal vendas As ncDados.nsVenda.ColecaoVendasPorVendedor)
        ...
        Dim paragrafoTitulo As New Paragraph("Relatório de Vendas da Loja", fonteTitulo)
        ...
        Dim coluna1 As New Paragraph("Tot. Vendas", fonte)
