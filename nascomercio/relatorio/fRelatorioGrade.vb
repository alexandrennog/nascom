        ...
        If Not rtbGrade.Tag Then
            ...
            Try
                If (Validar()) Then
                    ...
                    filtro.filtrarVenda = chkFiltrarVenda.Checked

                    If Not String.IsNullOrEmpty(txtDataEntradaInicio.Text.Trim()) Then
                        If Not cFuncoes.ValidarData(txtDataEntradaInicio.Text) Then
                            MessageBox.Show("Data inicial de entrada invalida!", "Grade", MessageBoxButtons.OK, MessageBoxIcon.Information)
                            txtDataEntradaInicio.Focus()
                            rtbGrade.Tag = False
                            Exit Sub
                        End If
                        filtro.dataEntradaInicio = cFuncoes.FormatarData(txtDataEntradaInicio.Text)
                    End If

                    If Not String.IsNullOrEmpty(txtDataEntradaFim.Text.Trim()) Then
                        If Not cFuncoes.ValidarData(txtDataEntradaFim.Text) Then
                            MessageBox.Show("Data final de entrada invalida!", "Grade", MessageBoxButtons.OK, MessageBoxIcon.Information)
                            txtDataEntradaFim.Focus()
                            rtbGrade.Tag = False
                            Exit Sub
                        End If
                        filtro.dataEntradaFim = cFuncoes.FormatarData(txtDataEntradaFim.Text)
                    End If

                    If Not String.IsNullOrEmpty(filtro.dataEntradaInicio) And Not String.IsNullOrEmpty(filtro.dataEntradaFim) Then
                        If filtro.dataEntradaFim < filtro.dataEntradaInicio Then
                            MessageBox.Show("Data final de entrada nao pode ser anterior a data inicial!", "Grade", MessageBoxButtons.OK, MessageBoxIcon.Information)
                            txtDataEntradaInicio.Focus()
                            rtbGrade.Tag = False
                            Exit Sub
                        End If
                        ...
                        For Each itemRef As dGradeItem In colReferencia
                            ...
                            If Not IsNothing(colProdutos) Then
                                ...
                                For Each itemPro As dGradeItem In colProdutos
                                    ...
                                    colItens = regras.ConsultarItens(itemPro.produto_cid, filtro)
