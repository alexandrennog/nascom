...
Public Class fUsuarioPerfilFiltro
  ...
  Private Sub Pesquisar()
    Dim filtro As dUsuarioPerfil

    filtro = New dUsuarioPerfil
    ...
    fUsuarioPerfilLista.filtro = filtro

    mdiPrincipal.CarregarUsuarioPerfilLista()
  End Sub

  Private Sub fUsuarioPerfilFiltro_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub fUsuarioPerfilFiltro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
