...
Public Class fCondicaoForm
  ...
  Private Sub Salvar()
    ...
    Try
      ...
      If MessageBox.Show("Confirma " & tipoMsg & " das informações?", tipoMsg, MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = Windows.Forms.DialogResult.Yes Then
        ...
        dados.desconto = cFuncoes.TratarDecimal(txtDesconto.Text)
    ...
    Catch ex As Exception
      ...
      MessageBox.Show("Erro na " & tipoMsg.ToLower() & " dos dados de Condicao.")
  ...
  Private Sub Excluir()
    ...
    Catch ex As Exception
      ...
      MessageBox.Show("Erro na exclusão dos dados de Condicao.")
  ...
  Private Sub ExibirInformacoesTela()
      ...
      If Not Me.cid.Equals(Nothing) Then
        If Not Me.cid.Equals(0) Then
          ...
          If Not dados Is Nothing Then
            ...
            txtDesconto.Text = cFuncoes.RetornarDecimal(dados.desconto)
    ...
    Catch ex As Exception
      ...
      MessageBox.Show("Erro na consulta dos dados de Condicao.")
  ...
  Private Sub fCondicaoForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    If Me.Modal = True Then
  ...
  Private Sub fCondicaoForm_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
