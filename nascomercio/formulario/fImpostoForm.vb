...
Public Class fImpostoForm
    ...
    Public regra_cid As Nullable(Of Integer)
    ...
    Private Function Validar() As Boolean
        Try
            ...
            If String.IsNullOrEmpty(txtDescricao.Text.Trim()) Then
                MessageBox.Show("É necessário informar a Descrição da regra!")
                Return False
            End If
            ...
            If Not cFuncoes.ValidarValor(cboTipoOperacao.SelectedValue) Then
                MessageBox.Show("É necessário informar o Tipo de Operação!")
                Return False
            End If
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            If MessageBox.Show("Confirma gravação das informações de Impostos?", "IMPOSTOS", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = Windows.Forms.DialogResult.Yes Then
        ...
        Catch ex As Exception
            ...
            MessageBox.Show("Erro na gravação dos dados de Impostos.")
    ...
    Private Sub Excluir()
        ...
        Try
            ...
            If regraAtual.HasValue Then
                If MessageBox.Show("Confirma a REMOÇÃO do vínculo desta regra fiscal com o produto?", "REMOVER", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = Windows.Forms.DialogResult.Yes Then
        ...
        Catch ex As Exception
            ...
            MessageBox.Show("Erro na remoção do vínculo de Impostos.")
    ...
    Private Sub CarregarComboTipoOperacao()
        ...
        Catch ex As Exception
            ...
            MessageBox.Show("Erro na consulta dos dados de Tipo de Operação.")
    ...
    Private Sub IncluirCfop()
        ...
        Catch ex As Exception
            ...
            MessageBox.Show("Erro na inclusão do CFOP.")
    ...
    Private Sub ExcluirCfop()
        ...
        Catch ex As Exception
            ...
            MessageBox.Show("Erro na exclusão do CFOP.")
    ...
    Private Sub fImpostoForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ExibirRegra(Me.regra_cid)

        If Not Me.regra_cid.HasValue Then
