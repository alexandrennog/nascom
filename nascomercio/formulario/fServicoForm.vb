...
Public Class fServicoForm
  ...
  Private Sub Salvar()
    ...
    Try
      ...
      If MessageBox.Show("Confirma " & tipoMsg & " das informações?", tipoMsg, MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = Windows.Forms.DialogResult.Yes Then
        ...
        dados.valor = cFuncoes.TratarDecimal(txtValor.Text)
        ...
        If tipoAcao.Equals("i") Then
          ...
          Else
            MessageBox.Show("Servico já cadastrado.")
          End If
          Me.cid = novoCID
    ...
    Catch ex As Exception
      ...
      MessageBox.Show("Erro na " & tipoMsg.ToLower() & " dos dados de Servico.")
  ...
  Private Sub Excluir()
    ...
    Catch ex As Exception
      ...
      MessageBox.Show("Erro na exclusão dos dados de Servico.")
  ...
  Private Sub ExibirInformacoesTela()
      ...
      If Not Me.cid.Equals(Nothing) Then
        If Not Me.cid.Equals(0) Then
          ...
          If Not dados Is Nothing Then
            ...
            txtValor.Text = cFuncoes.RetornarTexto(dados.valor)
    ...
    Catch ex As Exception
      ...
      MessageBox.Show("Erro na consulta dos dados de Servico.")
  ...
  Private Sub fServicoForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    If Me.Modal = True Then
  ...
  Private Sub fServicoForm_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
