...
Public Class fPixConfigForm
    ...
    Private Sub Excluir()
        ...
        Catch ex As Exception
            ...
            MessageBox.Show("Erro na exclusão dos dados da Cor.")
    ...
    Private Sub ExibirInformacoesTela()
        ...
        Catch ex As Exception
            ...
            MessageBox.Show("Erro na consulta dos dados da Cor.")
    ...
    Private Sub fCorForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub fCorForm_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub SelecionarNovaCor()
        If Me.Modal = True Then
            If Not Me.cid.Equals(Nothing) Then
                fProdutoForm.SelecionarNovaCor(Me.cid)
            End If
