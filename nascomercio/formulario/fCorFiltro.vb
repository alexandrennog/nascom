...
Public Class fCorFiltro
  ...
  Private Sub Pesquisar()
    ...
    fCorLista.filtro = filtro

    mdiPrincipal.CarregarCorLista()
  End Sub
  ...
  Private Sub fCorFiltro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    CarregarComboSituacao()
  End Sub

  Private Sub fCorFiltro_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
