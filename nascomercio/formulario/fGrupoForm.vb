...
Public Class fGrupoForm
  ...
  Private Sub Salvar()
    ...
    Catch ex As Exception
      ...
      MessageBox.Show("Erro na " & tipoMsg.ToLower() & " dos dados da Grupo.")

    End Try
  End Sub

  Private Sub SelecionarNovoGrupo()
    If Me.Modal = True Then
      If Not Me.cid.Equals(Nothing) Then
        fProdutoForm.SelecionarNovoGrupo(Me.cid)
      End If
  ...
  Private Sub Excluir()
    ...
    Catch ex As Exception
      ...
      MessageBox.Show("Erro na exclusão dos dados da Grupo.")
  ...
  Private Sub ExibirInformacoesTela()
    ...
    Catch ex As Exception
      ...
      MessageBox.Show("Erro na consulta dos dados da Grupo.")
  ...
  Private Sub fGrupoForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    LimparCampos()
    CarregarComboSituacao()
    ExibirInformacoesTela()
  End Sub

  Private Sub fGrupoForm_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
