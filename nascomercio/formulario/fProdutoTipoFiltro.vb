...
Public Class fProdutoTipoFiltro
  ...
  Private Sub Pesquisar()
    Dim filtro As dProdutoTipo

    filtro = New dProdutoTipo

    filtro.nome = cFuncoes.TratarTexto(txtNome.Text)
    filtro.situacao = cFuncoes.TratarTexto(cboSituacao.SelectedValue)

    fProdutoTipoLista.filtro = filtro

    mdiPrincipal.CarregarProdutoTipoLista()
  End Sub
  ...
  Private Sub fProdutoTipoFiltro_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub fProdutoTipoFiltro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
