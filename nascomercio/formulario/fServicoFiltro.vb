...
Public Class fServicoFiltro
  ...
  Private Sub Pesquisar()
    Dim filtro As dServico

    filtro = New dServico

    filtro.nome = cFuncoes.TratarTexto(txtNome.Text)
    filtro.valor = cFuncoes.TratarTexto(txtValor.Text)
    filtro.situacao = cFuncoes.TratarTexto(cboSituacao.SelectedValue)

    fServicoLista.filtro = filtro

    mdiPrincipal.CarregarServicoLista()
  End Sub
  ...
  Private Sub fServicoFiltro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    CarregarComboSituacao()
  End Sub

  Private Sub fServicoFiltro_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
