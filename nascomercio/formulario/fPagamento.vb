...
Public Class fPagamento
    ...
    Private Function RecuperarImpostos(ByVal regra_cid As Nullable(Of Integer)) As ncDados.nsDadosImpostos.dDadosImpostos
        ...
        Try
            ...
            If Not regra_cid.HasValue Then
                Throw New ArgumentNullException(NameOf(regra_cid), "Regra de ID não pode ser nula")
            End If
            ...
            ' Sem regra tributária localizada, não há impostos a recuperar
        ...
        Catch ex As ArgumentNullException
            GravarLog(mdiPrincipal.gUsuario.usuario, "Validação falhou em RecuperarImpostos: " & ex.Message)
            MessageBox.Show("Regra de ID é obrigatória.", "Validação", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Return Nothing
    ...
    ''' <summary>
    ''' Converte o dDadosImpostos consultado das regras tributárias (ncDados) para o
