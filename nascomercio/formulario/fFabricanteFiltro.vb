...
Public Class fFabricanteFiltro
  ...
  Private Sub Pesquisar()
    Dim filtro As dFabricante

    filtro = New dFabricante

    filtro.nome = cFuncoes.TratarTexto(txtNome.Text)
    filtro.situacao = cFuncoes.TratarTexto(cboSituacao.SelectedValue)

    fFabricanteLista.filtro = filtro

    mdiPrincipal.CarregarFabricanteLista()
  End Sub
  ...
  Private Sub fFabricanteFiltro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    CarregarComboSituacao()
  End Sub

  Private Sub fFabricanteFiltro_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
