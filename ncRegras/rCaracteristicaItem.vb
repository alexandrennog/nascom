  ...
  Public Class rCaracteristicaItem
    ...
    Public Function Listar() As ColecaoCaracteristicaItem
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Listar CaracteristicaItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function Consultar(ByVal dados As dCaracteristicaItem) As ColecaoCaracteristicaItem
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Consultar CaracteristicaItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function ConsultarPorCID(ByVal cid As Integer) As dCaracteristicaItem
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em ConsultarPorCID CaracteristicaItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function ConsultarPorCaracteristica(ByVal caracteristica_cid As Integer) As ColecaoCaracteristicaItem
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em ConsultarPorCaracteristica CaracteristicaItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function Incluir(ByVal dados As dCaracteristicaItem) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Incluir CaracteristicaItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function Alterar(ByVal dados As dCaracteristicaItem) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Alterar CaracteristicaItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function Excluir(ByVal dados As dCaracteristicaItem) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Excluir CaracteristicaItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fListar() As ColecaoCaracteristicaItem
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fListar CaracteristicaItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fConsultar(ByVal dados As dCaracteristicaItem) As ColecaoCaracteristicaItem
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fConsultar CaracteristicaItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fIncluir(ByVal dados As dCaracteristicaItem) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fIncluir CaracteristicaItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fAlterar(ByVal dados As dCaracteristicaItem) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fAlterar CaracteristicaItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fExcluir(ByVal dados As dCaracteristicaItem) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fExcluir CaracteristicaItem [" & Me.ToString() & "] - " & ex.Message)
