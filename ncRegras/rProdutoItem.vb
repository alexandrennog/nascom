  ...
  Public Class rProdutoItem
    ...
    Public Function ConsultarUltimoCodigoBarras() As String
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em ConsultarUltimoCodigoBarras ProdutoItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function Selecionar(ByVal dados As dProdutoItem) As dProdutoItem
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Selecionar ProdutoItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function ConsultarPorProduto(ByVal produto_cid As Integer) As ColecaoProdutoItem
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em ConsultarPorProduto ProdutoItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    End Function
        ...
        Public Function AlterarEstoque(ByVal codigoBarras As String, ByVal quantidade As Decimal, ByVal somar As Boolean) As Integer
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em AlterarEstoque ProdutoItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function ExcluirPorProduto(ByVal dados As dProdutoItem) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em ExcluirPorPoduto ProdutoItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fListar() As ColecaoProdutoItem
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fListar ProdutoItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fConsultarUltimoItem(ByVal produto_cid As Integer) As Nullable(Of Integer)
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fConsultarUltimoItem ProdutoItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fConsultarUltimoCodigoBarras() As String
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fConsultarUltimoCodigoBarras ProdutoItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    End Function
        ...
        Public Function fConsultarEstoque(ByVal codigoBarras As String) As Decimal
            ...
            Catch ex As Exception
                ...
                retorno = 0
                Throw New ExcecaoNascomercio("Erro em fConsultarEstoque ProdutoItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fIncluir(ByVal dados As dProdutoItem) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fIncluir ProdutoItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fAlterar(ByVal dados As dProdutoItem) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fAlterar ProdutoItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fExcluir(ByVal dados As dProdutoItem) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fExcluir ProdutoItem [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fExcluirPorProduto(ByVal dados As dProdutoItem) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fExcluirPorProduto ProdutoItem [" & Me.ToString() & "] - " & ex.Message)
