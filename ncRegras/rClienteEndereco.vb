  ...
  Public Class rClienteEndereco
    ...
    Public Function ConsultarPorCID(ByVal cid As Integer) As dClienteEndereco
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Consultar ClienteEndereco [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fListar() As ColecaoClienteEndereco
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fListar Cliente - Endereço [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fConsultar(ByVal dados As dClienteEndereco) As ColecaoClienteEndereco
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fConsultar Cliente - Endereço [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fIncluir(ByVal dados As dClienteEndereco) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fIncluir Cliente - Endereço [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fExcluirPorCliente(ByVal cliente_cid As Integer) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fExcluir Cliente - Endereço [" & Me.ToString() & "] - " & ex.Message)
