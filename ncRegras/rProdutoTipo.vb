  ...
  Public Class rProdutoTipo
    ...
    Public Function Listar() As ColecaoProdutoTipo
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Listar ProdutoTipo [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function Consultar(ByVal dados As dProdutoTipo) As ColecaoProdutoTipo
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Consultar ProdutoTipo [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function Incluir(ByVal dados As dProdutoTipo) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Incluir ProdutoTipo [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function Alterar(ByVal dados As dProdutoTipo) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Alterar ProdutoTipo [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function Excluir(ByVal dados As dProdutoTipo) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Excluir ProdutoTipo [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fListar() As ColecaoProdutoTipo
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fListar ProdutoTipo [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fConsultar(ByVal dados As dProdutoTipo) As ColecaoProdutoTipo
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fConsultar ProdutoTipo [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fIncluir(ByVal dados As dProdutoTipo) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fIncluir ProdutoTipo [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fAlterar(ByVal dados As dProdutoTipo) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fAlterar ProdutoTipo [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fExcluir(ByVal dados As dProdutoTipo) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fExcluir ProdutoTipo [" & Me.ToString() & "] - " & ex.Message)
