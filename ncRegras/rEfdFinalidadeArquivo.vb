  ...
  Public Class rEfdFinalidadeArquivo
    ...
    Public Function Listar() As ColecaoEfdFinalidadeArquivo
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Listar EfdFinalidadeArquivo [" & Me.ToString() & "] - " & ex.Message, ex)
    ...
    Public Function fListar() As ColecaoEfdFinalidadeArquivo
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fListar EfdFinalidadeArquivo [" & Me.ToString() & "] - " & ex.Message, ex)
