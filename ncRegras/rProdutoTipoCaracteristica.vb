    ...
    Public Class rProdutoTipoCaracteristica
        ...
        Public Function ConsultarPorProdutoTipo(ByVal produtoTipo_cid As Integer) As ColecaoProdutoTipoCaracteristica
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em ConsultarPorProdutoTipo ProdutoTipoCaracteristica [" & Me.ToString() & "] - " & ex.Message, ex)
        ...
        Public Function fListar() As ColecaoProdutoTipoCaracteristica
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em fListar ProdutoTipoCaracteristica [" & Me.ToString() & "] - " & ex.Message, ex)
        ...
        Public Function fConsultar(ByVal dados As dProdutoTipoCaracteristica) As ColecaoProdutoTipoCaracteristica
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em fConsultar ProdutoTipoCaracteristica [" & Me.ToString() & "] - " & ex.Message, ex)
        ...
        Public Function fIncluir(ByVal dados As dProdutoTipoCaracteristica) As Integer
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em fIncluir ProdutoTipoCaracteristica [" & Me.ToString() & "] - " & ex.Message, ex)
        ...
        Public Function fExcluirPorProdutoTipo(ByVal produtoTipo_cid As Integer) As Integer
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em fExcluir ProdutoTipoCaracteristica [" & Me.ToString() & "] - " & ex.Message, ex)
