  ...
  Public Class rMunicipios
    ...
    Public Function ListarPorEstados(ByVal estados_cid As Integer) As ColecaoMunicipios
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em ListarPorEstados municipios [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fListar() As ColecaoMunicipios
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fListar municipios [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fListarPorEstado(ByVal estados_cid As Integer) As ColecaoMunicipios
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fListarPorEstado municipios [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fConsultar(ByVal dados As dMunicipios) As ColecaoMunicipios
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fConsultar municipios [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fIncluir(ByVal dados As dMunicipios) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fIncluir municipios [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fImportar(ByVal dados As dMunicipios) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fImportar municipios [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fAlterar(ByVal dados As dMunicipios) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fAlterar municipios [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fExcluir(ByVal dados As dMunicipios) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fExcluir municipios [" & Me.ToString() & "] - " & ex.Message)
