    ...
    Public Class rCrediario
        ...
        Public Function Listar() As ColecaoCrediario
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em Listar Crediario [" & Me.ToString() & "] - " & ex.Message)
        ...
        Public Function ConsultarParcela(ByVal cid As Integer) As dParcelas
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em ConsultarParcela [" & Me.ToString() & "] - " & ex.Message)
        ...
        Public Function IncluirParcela(ByVal dadosParcela As dParcelas) As Integer
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em Incluir Parcela [" & Me.ToString() & "] - " & ex.Message)
        ...
        Public Function GravarPagamentoParcelas(ByVal dadosParcelas As ColecaoParcelas) As Integer
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em Gravar Pagamento Parcela [" & Me.ToString() & "] - " & ex.Message)
        ...
        Public Function CorrigirParcelas() As Integer
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro ao corrigir parcelas [" & Me.ToString() & "] - " & ex.Message)
