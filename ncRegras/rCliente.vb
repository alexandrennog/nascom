    ...
    Public Class rCliente
        ...
        Public Function fListar() As ColecaoCliente
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em fListar Cliente [" & Me.ToString() & "] - " & ex.Message)
        ...
        Public Function fConsultar(ByVal dados As dCliente) As ColecaoCliente
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em fConsultar Cliente [" & Me.ToString() & "] - " & ex.Message)
        ...
        Public Function fIncluir(ByVal dados As dCliente) As Integer
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em fIncluir Cliente [" & Me.ToString() & "] - " & ex.Message)
        ...
        Public Function fAlterar(ByVal dados As dCliente) As Integer
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em fAlterar Cliente [" & Me.ToString() & "] - " & ex.Message)
        ...
        Public Function fExcluir(ByVal dados As dCliente) As Integer
            ...
            Catch ex As Exception
                ...
                retorno = Nothing
                Throw New ExcecaoNascomercio("Erro em fExcluir Cliente [" & Me.ToString() & "] - " & ex.Message)
