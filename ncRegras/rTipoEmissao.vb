  ...
  Public Class rTipoEmissao
    ...
    Public Function Listar() As ColecaoTipoEmissao
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Listar TipoEmissao [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fListar() As ColecaoTipoEmissao
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fListar TipoEmissao [" & Me.ToString() & "] - " & ex.Message)
