  ...
  Public Class rEfdTipoPessoa
    ...
    Public Function Listar() As ColecaoEfdTipoPessoa
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em Listar EfdTipoPessoa [" & Me.ToString() & "] - " & ex.Message, ex)
    ...
    Public Function fListar() As ColecaoEfdTipoPessoa
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fListar EfdTipoPessoa [" & Me.ToString() & "] - " & ex.Message, ex)
