  ...
  Public Class rClienteFinanceiro
    ...
    Public Function fListar() As ColecaoClienteFinanceiro
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fListar Cliente - Financeiro [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fConsultar(ByVal dados As dClienteFinanceiro) As ColecaoClienteFinanceiro
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fConsultar Cliente - Financeiro [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fIncluir(ByVal dados As dClienteFinanceiro) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fIncluir Cliente - Financeiro [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fAlterar(ByVal dados As dClienteFinanceiro) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fAlterar Cliente - Financeiro [" & Me.ToString() & "] - " & ex.Message)
    ...
    Public Function fExcluirPorCliente(ByVal cliente_cid As Integer) As Integer
      ...
      Catch ex As Exception
        ...
        retorno = Nothing
        Throw New ExcecaoNascomercio("Erro em fExcluir Cliente - Financeiro [" & Me.ToString() & "] - " & ex.Message)
