...
{
    public class rProdutoItem : IsProdutoItem
    {
        private readonly IpProdutoItem _repo;
        public rProdutoItem(IpProdutoItem repo) { _repo = repo; }
        ...
        {
            try { return AlterarEstoque(codigoBarras, quantidade, true); }
            catch (ExcecaoNascomercio) { throw; }
        ...
        {
            try { return _repo.AlterarEstoque(codigoBarras, quantidade, somar); }
            catch (ExcecaoNascomercio) { throw; }
            catch (Exception ex) { throw new ExcecaoNascomercio("Erro em AlterarEstoque ProdutoItem [" + ToString() + "] - " + ex.Message); }
        }
